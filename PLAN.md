...
| ~~P1~~ | ~~多语言支持~~ | ✅ i18n 中英文切换 |
| ~~P1~~ | ~~大文件哈希优化~~ | ✅ 支持 xxHash 与大文件采样，显著降低大文件扫描耗时 |
| ~~P2~~ | ~~文件预览~~ | ✅ 图片/视频/音频预览，结果列表显示缩略图 |
| ~~P2~~ | ~~键盘快捷键~~ | ✅ 支持 Delete / Ctrl+A / Escape |
| ~~P2~~ | ~~扫描历史 UI~~ | ✅ 保留多次扫描记录，可查看并恢复历史扫描 |
| ~~P2~~ | ~~自动更新机制~~ | ✅ 启动时检查新版本并提示更新 |
| ~~P3~~ | ~~忽略规则配置~~ | ✅ 支持最小大小、排除目录、排除后缀 |
| P3 | 删除撤销 | 支持撤销删除操作 |
| ~~P3~~ | ~~符号链接处理~~ | ✅ 支持跳过/跟随/仅报告 |
| ~~P3~~ | ~~隐藏文件开关~~ | ✅ Settings 支持是否扫描隐藏文件 |
| ~~P3~~ | ~~文件名查重模式~~ | ✅ 支持按文件名分组查重 |
| ~~P3~~ | ~~设置导入导出~~ | ✅ 支持备份/恢复扫描配置 |
| ~~P3~~ | ~~磁盘空间分析~~ | ✅ 支持按文件类型查看重复空间占用 |
